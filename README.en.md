...
- Scheduled orders can be moved into production. Starting production locks all allocations for that order. In-progress orders can be confirmed as fully complete or partially complete; partial completion closes the produced quantity and creates a pending child order for the remainder.
